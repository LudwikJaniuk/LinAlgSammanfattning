...
\definition{Bas}
En bas är grunden för ett vektorrum och utgörs av ett antal \emph{basvektorer}, vilka: 

\begin{itemize}
	\item Är linjärt oberoende  
	\item Spänner upp vektorrummet
...
Notera att en bas inte är unik för ett vektorrum, vilka vektorer som helst som uppfyller villkoren är en bas för vektorrummet.
